...
export const FinanceCalculatorView: React.FC<{ logic: ReturnType<typeof useFinanceCalculator> }> = ({ logic }) => {
    ...
    const inputClass = "w-full rounded-2xl bg-surface p-4 text-xl outline-none ring-1 ring-text-color/20 transition-all text-right font-mono caret-primary h-full flex items-center justify-end";
    ...
    return (
        <div className="flex-1 overflow-hidden p-4 flex flex-col h-full w-full">
            <div className="flex-1 flex flex-col gap-4 min-h-0">
                ...
                <div className="rounded-2xl bg-surface p-4 space-y-3 shadow-lg shrink-0 mt-auto">
                    <div className="flex justify-between items-center pb-3 border-b border-text-color/10">
                        <span className="text-text-muted text-sm font-bold uppercase">{t('finalPrice')}</span>
